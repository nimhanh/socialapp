        ...
        <Box sx={style}>
          ...
          <div className="flex justify-center py-10">
            <div className="w-[80%] space-y-10 ">
              <div className="p-5 rounded-md flex item-center justify-between bg-slate-400 shadow-lg">
                <h1 className="text-xl pr-5">
                  Blue subscription with a verified phone number will get a blue
                  chechmark once approved.
                </h1>
                <img
                  className="w-24 h-24"
              ...
              <div className="flex justify-between border rounded-full px-5 py-3 border border-gray-500">
                <div>
                  <span
                    ...
                    classname={
                      '${plan==="Anunalluy"?"text-black":"gray-400"}cursor-pointer'
                    }
                  >
                    Anunalluy
                  </span>
                ...
                <p
                  ...
                  classname={
                    '${plan==="monthly"?"text-black":"gray-400"}cursor-pointer'
                  }
                >
                  Monthly
                </p>
